...
$sum=0;
                    ...
                    <a href='delll.php?id=$cart_item[product_id]' class='text-muted delete-item' ><i class='fas fa-times'></i></a>
                    </div>
                  </div>
";
                      }
                ...
                <div class="p-5">
                  ...
                  <div class="mb-5">
                    <div class="form-outline">
                      <input type="text" id="form3Examplea2" class="form-control form-control-lg" name="phone_number" required />
                      <label class="form-label" for="form3Examplea2">Enter your phone number</label>
                    </div>
                  </div>
...
<div class="mb-5">
  <div class="form-outline">
    <input type="text" id="form3Examplea2" class="form-control form-control-lg" name="address" required />
